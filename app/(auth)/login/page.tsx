...
function mapFirebaseError(code: string | undefined): string {
  switch (code) {
    ...
    case "auth/unauthorized-domain":
      return "Ce domaine n’est pas autorisé pour la connexion.";
    case "auth/operation-not-allowed":
      return "La connexion Apple n’est pas activée.";
    default:
...
function LoginForm() {
  ...
  return (
    <div
      className="min-h-[100dvh] bg-white pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-[max(0.75rem,env(safe-area-inset-top))]"
    >
